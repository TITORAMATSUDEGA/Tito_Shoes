...
<body class="admin-theme-bg font-sans min-h-screen flex items-center justify-center p-4 lg:p-8">
    <div class="max-w-2xl w-full bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
        <div class="bg-slate-900 px-8 py-10 text-white relative overflow-hidden">
            ...
            <h2 class="text-3xl font-black tracking-tight">Tambah <span class="text-cyan-400">Sepatu</span> Baru</h2>
        ...
        <form action="{{ route('shoes.store') }}" method="POST" enctype="multipart/form-data" class="p-8 lg:p-10 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" name="name" placeholder="Contoh: Nike Air Jordan 1" required class="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500 focus:bg-white outline-none transition-all font-bold text-slate-700">
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price" placeholder="0" required class="w-full pl-12 pr-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500 focus:bg-white outline-none transition-all font-bold text-slate-700">
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="relative group">
                    ...
                    <div id="dropzone" class="w-full px-5 py-8 bg-slate-50 border-2 border-dashed border-slate-200 rounded-2xl group-hover:bg-slate-100 group-hover:border-cyan-500 transition-all flex flex-col items-center justify-center text-center">
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" rows="4" placeholder="Ceritakan keunggulan sepatu ini..." class="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500 focus:bg-white outline-none transition-all font-medium text-slate-700"></textarea>
            </div>
            
            <div class="flex gap-4 pt-4">
                <button type="submit" class="flex-1 bg-cyan-600 hover:bg-cyan-700 text-white px-8 py-4 rounded-2xl font-black shadow-lg shadow-cyan-500/20 transition-all hover:-translate-y-1">Simpan Katalog</button>
